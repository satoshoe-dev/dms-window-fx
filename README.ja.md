...
ウィンドウが閉じると、niri はそれをすぐにレイアウトから外します。閉じるアニメーションがまだ上に描かれている間に、隣のウィンドウはすぐに空いた場所へ動き出します。短いフェードならほとんど目立ちませんが、燃えるふちや落ちていく破片だと、下を滑り込んでくるウィンドウの上で効果が流れ、両者が混ざってしまいます。
...
niri 26.04 向けのパッチは、私の niri フォークのブランチ [hold-layout-v26.04](https://github.com/satoshoe-dev/niri/tree/hold-layout-v26.04) にあります。ビルド方法は niri 本体と同じなので、niri の README を参照してください。
